...
import { useAdminTeacherFinancialRecords }     from "../../../hooks/useAdminTeacherFinancialRecords";
...
export default function View() {
  ...
  const {data, isLoading} = useAdminTeacherFinancialRecords(token);
              ...
              <TableBody>
                ...
                FinancialRecords
                  ...
                  .map((row) => {
                    ...
                    return (
                      <TableRow hover role="checkbox" key={row.id + "demj"}>
                        ...
                        <TableCell>
                          <Button onClick={() => navigate(`/admin/teacher-financial-records/${row.id}`)} style={{backgroundColor:"#000" , color:"#FFF" , display:"block" , borderRadius : "15px" , padding:"10px 20px" , margin:"auto"}}>
                           {t("Details")}
                          </Button>
                        </TableCell>
                      </TableRow>
                  ...
                  : <TableRow>
                      ...
                      <p>{t("cashbox_teacher_notfound")}</p>
                      </TableCell>
                    </TableRow>
                  }
              </TableBody>
