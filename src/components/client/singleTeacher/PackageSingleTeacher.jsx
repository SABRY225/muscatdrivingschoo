...
export default function PackageSingleTeacher({teacher}) {
    ...
    return (
        <Paper sx={{padding:"32px 24px",marginY:"30px"}}>
          <Typography sx={{fontSize:"22px",marginBottom:"18px"}}>{t('view_package')}</Typography>
            {
            ...
            <Paper sx={{ padding: "10px 6px",display: "flex",flexDirection: "column", alignItems: "center",backgroundColor:"#f1f1f1",borderRadius:"20px"}}
                  >
                    <Avatar
