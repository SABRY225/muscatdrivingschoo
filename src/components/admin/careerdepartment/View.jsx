...
import CareerDepartmentUpdate       from "./Update";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setCareerDepartments(CareerDepartments.filter((c) => c.id !== id));
      } else {
      ...
      {!isLoading ? (
        <Paper sx={{ padding: "20px" }}>
                      ...
                      <TableRow hover role="checkbox" key={row.id + "demj"}>
                        ...
                        <TableCell align="center">
                          ...
                          <Dialog open={open === row.id} onClose={handleClose}>
                            <CareerDepartmentUpdate
                              setCareerDepartments={setCareerDepartments}
                              careerdepartment={row}
          ...
          <TablePagination
            ...
            component="div"
            count={CareerDepartments?.length}
