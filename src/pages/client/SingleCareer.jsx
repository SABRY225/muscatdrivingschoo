...
export default function SingleCareer() {
  ...
  useEffect(() => {
    ...
    let c = countries.find((e) => e.code == current?.country);
    //console.log(c);
        ...
        <Container sx={{ marginBottom: "40px", marginTop: "40px" }}>
          <Grid container spacing={3}>
            ...
            <Grid data md={12} lg={4}>
              ...
              <table className="tableAdvertiser">
              <tr>
                  <td><b>{t("country")}</b></td>
                  <td><p className="p_details">{ lang === "en" ? country?.name_en : country?.name_ar }</p></td>
              </tr>
              <tr>
                <td><b>{t("advertiserName")}</b></td>
                <td><p>{currentObject?.advertiserName}</p></td>
              </tr>
              <tr>
                <td><b>{t("advertiserPhone")}</b></td>
                <td><p>{currentObject?.advertiserPhone}</p></td>
              </tr>
            </table>
              </Paper>
            </Grid>
