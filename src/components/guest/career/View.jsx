...
export default function CareerView() {
  ...
  const columns = [
    { id: "name_courseAr",       label: t("image"),       minWidth: 150 },
    { id: "name_courseAr",       label: t("careerDepartment"), minWidth: 150 },
    { id: "name_courseAr",       label: t("country"),     minWidth: 150 },
    { id: "name_courseEn",       label: t("title"),        minWidth: 150 },
    { id: "name_descriptionAr",  label: t("description"),   minWidth: 150 },
                  ...
                  .map((row) => {
                    ...
                    return (
                      <TableRow hover role="checkbox" key={row.id + "demj"}>
                        ...
                        <TableCell align="center">{ ( c != null ) ? lang === "en" ? c.name_en : c.name_ar  : ""}</TableCell>
