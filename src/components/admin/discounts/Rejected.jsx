...
import { Box, Button, TableRow , TextField, Paper , Table , TableBody, TableCell, TablePagination , TableContainer,Avatar  } from "@mui/material";
...
export default function Rejected() {
  ...
  useEffect(() => {
    if (data?.data) {
      ...
      let rowWaiting;
      rowWaiting = data?.data.find((e) => e.status == "0");
                ...
                Discounts
                  ...
                  <TableRow>
                    <TableCell align="center" colSpan={6}>
                      <p>{t("discount_rejected_notfound")}</p>
                    </TableCell>
                  </TableRow>
                }
              </TableBody>
