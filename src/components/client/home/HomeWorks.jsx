    ...
    return (
        <Box sx={{marginY:"60px"}}>
            ...
            <div className='contain_title'>
                ...
                <Typography sx={{fontSize:{md:"26px",xs:"22px"},fontWeight:"700",color:"#D10909",textAlign:"center",
                        ...
                        return(
                            <Grid container spacing={2} key={index+'m1'} sx={{marginBottom:{md:"12px",xs:"30px"}}}>
                                ...
                                <Grid item xs={12} md={8} lg={9} sx={{textAlign:{xs:"center",md:"start"}}}>
                                    <Typography sx={{fontSize:"28px",color:"#D10909",fontWeight:"700"}}>0{index+1}</Typography>
                                    <Typography sx={{color:"#D10909",fontWeight:"500",marginBottom:"10px"}}>{item.title}</Typography>
                ...
                <Box sx={{display:"flex",justifyContent:"center"}}>
                    <Button variant="contained" sx={{backgroundColor:"#D10909"}} onClick={()=>navigate('/teacherRegister/step1')}>{t('becometeacher')}</Button>
                </Box>
            </Container>
        </Box>
    )
