  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_API_KEY}api/v1/admin/exchangerequestparents/${id}`,
        {
          method: "DELETE",
          headers: {
        ...
        <Paper sx={{ width: "100%", padding: "20px" }}>
          <TableContainer sx={{ maxHeight: 440 }}>
            ...
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {ExchangeRequestsParents.length > 0 ?
                      ...
                      <TableRow hover role="checkbox" key={row.id + "demj"}>
                        ...
                        <TableCell align="center">
                          ...
                          <Dialog open={open === row.id} onClose={handleClose}>
                            <Update
                              setExchangeRequestsParents={setExchangeRequestsParents}
                              exchangerequestsparent={row}
