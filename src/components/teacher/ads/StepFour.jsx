  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_KEY}api/v1/teacher/ads-step-four/${AdsId}`,
        {
          method: "PUT",
          headers: {
    ...
    <Navbar>
      ...
      <Container sx={{ marginTop: "20px", marginBottom: "60px" }}>
        ...
        <Box sx={{flex:1, marginBottom: "26px" }}>
              ...
              <Controller
                name="yearManufacture"  control={control} render={({ field }) => <TextField {...field} fullWidth type="number" />}
